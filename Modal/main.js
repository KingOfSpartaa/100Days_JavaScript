...
const actionThreeBtn = document
  ...
  const darkBackgroundMenu = document.querySelector('.CitiPage')
  document.querySelector('.LoginDropdown::before').addEventListener('click', (e) => {if(e.target.classList.contains(".LoginDropdown")){e.target.remove()}})